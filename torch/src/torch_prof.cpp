...
void TorchProf::TensorCallback::reportMemoryUsage(void* ptr, int64_t alloc_size, size_t total_allocated,
...
#else
void TorchProf::TensorCallback::reportMemoryUsage(void* ptr, int64_t alloc_size, int64_t total_allocated,
